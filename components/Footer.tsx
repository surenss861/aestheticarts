...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-neutral-800 via-neutral-800 to-neutral-900 text-neutral-300 overflow-hidden border-t border-primary-800/30">
      {/* Decorative elements */}
