        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left" className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-neutral-700 leading-relaxed">
              <p>
                Welcome to <span className="font-bold text-gold-600">Aesthetic Arts</span>!
              ...
              <p className="text-xl font-semibold text-gold-600 pt-4">
            ...
            <Link
              href="/about"
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-gold-600 to-gold-500 text-white px-6 py-3 rounded-full hover:from-gold-700 hover:to-gold-600 transition-colors duration-200 font-semibold shadow-md"
            >
          ...
          <ScrollReveal direction="right" className="space-y-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-champagne-50 to-gold-50 p-2 rounded-3xl">
              ...
              <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
                <p className="text-sm font-semibold text-gold-600">Amy Jagarinec RPN</p>
              </div>
            </motion.div>
