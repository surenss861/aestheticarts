      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left" className="space-y-8">
            ...
            <Link
              href="/about"
              className="inline-flex items-center space-x-2 bg-primary-600 text-white px-6 py-3 rounded-md hover:bg-primary-700 transition-colors duration-200 font-semibold shadow-md"
            >
          ...
          <ScrollReveal direction="right" className="space-y-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary-50 to-neutral-50 p-2 rounded-3xl">
