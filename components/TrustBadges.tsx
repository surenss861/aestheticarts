          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {badges.map((badge, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-lg transition-all duration-300 h-full border border-gold-100/50 group-hover:border-gold-200 group-hover:-translate-y-1">
                    {/* Professional Icon */}
                    <div className="inline-flex items-center justify-center mb-4">
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-gold-50 to-champagne-100 flex items-center justify-center group-hover:from-gold-100 group-hover:to-champagne-200 transition-all duration-300">
                        <Icon className="w-8 h-8 text-gold-600" />
                      </div>
                    </div>
                    
                    <h3 className="text-base font-bold text-neutral-900 mb-1 group-hover:text-gold-600 transition-colors">
                      {badge.title}
                    </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            {brands.map((brand, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-neutral-50 rounded-xl p-6 text-center h-full flex items-center justify-center border border-neutral-200 hover:border-gold-300 hover:bg-white transition-all duration-300 hover:shadow-md">
