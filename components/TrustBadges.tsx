          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {badges.map((badge, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-lg transition-all duration-300 h-full border border-neutral-100 group-hover:border-primary-200 group-hover:-translate-y-1">
                    {/* Professional Icon */}
                    <div className="inline-flex items-center justify-center mb-4">
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center group-hover:from-primary-100 group-hover:to-primary-200 transition-all duration-300">
